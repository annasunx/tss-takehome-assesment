...
<Note> **New in v2.0**: GraphQL endpoint at `https://api.salsaasaservice.com/graphql`</Note>
...
<Note> **API Key**: Get your API key from the [Developer Settings](https://app.salsaasaservice.com/settings/api) in your dashboard. </Note>
