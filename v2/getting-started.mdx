...
<Tip>Tip: Enterprise customers can enable Single Sign-On during signup for seamless team access.</Tip>
...
<Steps>
  <Step title="1. **Hardware Selection**">
  ...
  <Step title="2. **Physical Installation**">
