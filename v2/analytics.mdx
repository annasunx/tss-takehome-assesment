...
<Note> **New in v2.0**: AI analyzes all your data overnight and delivers a personalized daily briefing with the most important insights and recommended actions. </Note>
